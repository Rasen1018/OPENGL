...
void Widget::paintGL( )
{
    ...
    // 방향성 때문에 순서에 일관성이 있다.
    static GLubyte front[]  = {2,3,1,0}; 	// front face
    static GLubyte back[]   = {7,6,4,5}; 	// back face
    static GLubyte top[]    = {6,7,2,3}; 	// top face
    static GLubyte bottom[] = {4,5,0,1}; 	// bottom face
    static GLubyte left[]   = {3,7,0,4}; 		// left face
    static GLubyte right[]  = {6,2,5,1}; 		// right face
